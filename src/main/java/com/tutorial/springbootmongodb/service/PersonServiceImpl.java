package com.tutorial.springbootmongodb.service;

import com.tutorial.springbootmongodb.collecttion.Person;
import com.tutorial.springbootmongodb.repository.PersonRepository;
...
public class PersonServiceImpl implements PersonService{
    ...
    public List<Person> getPersonStartWith(String name) {
        return personRepository.findByFistNameStartsWith(name);
    }
